export default class sceneSetFlowerGlassesBeach extends Phaser.Scene {
    constructor(){
        super('sceneSetFlowerGlassesBeach')
    }
    preload(){
    ...
    create(){
        ...
        this.girl = this.add.image(-200, sceneHeight/1.9, 'set/flower/glasses/girl')
