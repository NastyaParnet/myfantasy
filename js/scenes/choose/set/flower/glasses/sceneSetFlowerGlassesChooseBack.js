export default class sceneSetFlowerGlassesChooseBack extends Phaser.Scene {
    constructor(){
        super('sceneSetFlowerGlassesChooseBack')
    }
    preload(){
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'set/flower/glasses/girl')
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.accessory=='beach') this.scene.start('sceneSetFlowerGlassesBeach');
            else this.scene.start('sceneSetFlowerGlassesSea');
        }
    }
}
