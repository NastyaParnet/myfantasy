export default class sceneSetFlowerNecklaceChooseBack extends Phaser.Scene {
    constructor(){
        super('sceneSetFlowerNecklaceChooseBack')
    }
    preload(){
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'set/flower/necklace/girl')
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.accessory=='beach') this.scene.start('sceneSetFlowerNecklaceBeach');
            else this.scene.start('sceneSetFlowerNecklaceSea');
        }
    }
}
