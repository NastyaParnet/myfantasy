export default class sceneSetFlowerNecklaceBeach extends Phaser.Scene {
    constructor(){
        super('sceneSetFlowerNecklaceBeach')
    }
    preload(){
    ...
    create(){
        ...
        this.girl = this.add.image(-200, sceneHeight/1.9, 'set/flower/necklace/girl')
