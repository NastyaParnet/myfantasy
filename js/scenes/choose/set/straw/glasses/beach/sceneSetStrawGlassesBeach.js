export default class sceneSetStrawGlassesBeach extends Phaser.Scene {
    constructor(){
        super('sceneSetStrawGlassesBeach')
    }
    preload(){
    ...
    create(){
        ...
        this.girl = this.add.image(-200, sceneHeight/1.9, 'set/straw/glasses/girl')
