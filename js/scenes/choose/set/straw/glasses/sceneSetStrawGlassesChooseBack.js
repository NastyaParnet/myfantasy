export default class sceneSetStrawGlassesChooseBack extends Phaser.Scene {
    constructor(){
        super('sceneSetStrawGlassesChooseBack')
    }
    preload(){
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'set/straw/glasses/girl')
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.accessory=='beach') this.scene.start('sceneSetStrawGlassesBeach');
            else this.scene.start('sceneSetStrawGlassesSea');
        }
    }
}
