export default class sceneSetStrawChooseAccessory extends Phaser.Scene {
    constructor(){
        super('sceneSetStrawChooseAccessory')
    }
    preload(){
        ...
        this.load.image('set/straw/glasses/girl', '../../assets/girl/set/straw/glasses/girl.png')
        this.load.image('set/straw/necklace/girl', '../../assets/girl/set/straw/necklace/girl.png')
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'set/straw/girl')
        ...
        function putGlasses () {
            destroyElements()
            girl = objectScene.add.image(sceneWidth/2, sceneHeight/2, 'set/straw/glasses/girl')
            girl.setScale(scaleObject)
            addProgress()
            addChoose()
            startTimer()
        ...
        function putNecklace () {
            destroyElements()
            girl = objectScene.add.image(sceneWidth/2, sceneHeight/2, 'set/straw/necklace/girl')
            girl.setScale(scaleObject)
            addProgress()
            addChoose()
            startTimer()
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.accessory=='glasses') this.scene.start('sceneSetStrawGlassesChooseBack');
            else this.scene.start('sceneSetStrawNecklaceChooseBack');
        }
    }
}
