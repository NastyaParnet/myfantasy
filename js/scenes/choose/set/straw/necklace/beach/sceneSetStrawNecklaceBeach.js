export default class sceneSetStrawNecklaceBeach extends Phaser.Scene {
    constructor(){
        super('sceneSetStrawNecklaceBeach')
    }
    preload(){
    ...
    create(){
        ...
        this.girl = this.add.image(-200, sceneHeight/1.9, 'set/straw/necklace/girl')
