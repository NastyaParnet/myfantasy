export default class sceneDressChooseBag extends Phaser.Scene {
    constructor(){
        super('sceneDressChooseBag')
    }
    preload(){
        this.load.image('straw', '../../assets/choose_bag/straw.png')
        this.load.image('flower', '../../assets/choose_bag/flower.png')
        this.load.image('dress/straw/girl', '../../assets/girl/dress/straw/girl.png')
        this.load.image('dress/flower/girl', '../../assets/girl/dress/flower/girl.png')
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'dress/girl')
        ...
        function putStraw () {
            destroyElements()
            girl = objectScene.add.image(sceneWidth/2, sceneHeight/2, 'dress/straw/girl')
            girl.setScale(scaleObject)
            addProgress()
            addChoose()
            startTimer()
        ...
        function putFlower () {
            destroyElements()
            girl = objectScene.add.image(sceneWidth/2, sceneHeight/2, 'dress/flower/girl')
            girl.setScale(scaleObject)
            addProgress()
            addChoose()
            startTimer()
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.bag=='straw') this.scene.start('sceneDressStrawChooseAccessory');
            else this.scene.start('sceneDressFlowerChooseAccessory');
        }
    }
}
