export default class sceneDressStrawGlassesBeach extends Phaser.Scene {
    constructor(){
        super('sceneDressStrawGlassesBeach')
    }
    preload(){
    ...
    create(){
        ...
        this.girl = this.add.image(-200, sceneHeight/1.9, 'dress/straw/glasses/girl')
