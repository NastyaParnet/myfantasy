export default class sceneDressStrawGlassesChooseBack extends Phaser.Scene {
    constructor(){
        super('sceneDressStrawGlassesChooseBack')
    }
    preload(){
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'dress/straw/glasses/girl')
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.accessory=='beach') this.scene.start('sceneDressStrawGlassesBeach');
            else this.scene.start('sceneDressStrawGlassesSea');
        }
    }
}
