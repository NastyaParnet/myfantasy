export default class sceneDressStrawNecklaceBeach extends Phaser.Scene {
    constructor(){
        super('sceneDressStrawNecklaceBeach')
    }
    preload(){
        this.load.image('beach', '../../assets/back/beach.png')
    ...
    create(){
        ...
        this.add.image(sceneWidth/2, sceneHeight/2, 'beach')

        this.boy = this.add.image(sceneWidth+200, sceneHeight/2, 'boy');
        this.boy.setScale(sceneHeight/1800);

        this.girl = this.add.image(-200, sceneHeight/1.9, 'dress/straw/necklace/girl')
