export default class sceneDressStrawChooseAccessory extends Phaser.Scene {
    constructor(){
        super('sceneDressStrawChooseAccessory')
    }
    preload(){
        ...
        this.load.image('dress/straw/glasses/girl', '../../assets/girl/dress/straw/glasses/girl.png')
        this.load.image('dress/straw/necklace/girl', '../../assets/girl/dress/straw/necklace/girl.png')
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'dress/straw/girl')
        ...
        function putGlasses () {
            destroyElements()
            girl = objectScene.add.image(sceneWidth/2, sceneHeight/2, 'dress/straw/glasses/girl')
            girl.setScale(scaleObject)
            addProgress()
            addChoose()
            startTimer()
        ...
        function putNecklace () {
            destroyElements()
            girl = objectScene.add.image(sceneWidth/2, sceneHeight/2, 'dress/straw/necklace/girl')
            girl.setScale(scaleObject)
            addProgress()
            addChoose()
            startTimer()
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.accessory=='glasses') this.scene.start('sceneDressStrawGlassesChooseBack');
            else this.scene.start('sceneDressStrawNecklaceChooseBack');
        }
    }
}
