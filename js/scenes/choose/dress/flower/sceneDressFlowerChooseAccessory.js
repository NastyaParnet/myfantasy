export default class sceneDressFlowerChooseAccessory extends Phaser.Scene {
    constructor(){
        super('sceneDressFlowerChooseAccessory')
    }
    preload(){
        this.load.image('glasses', '../../assets/choose_accessory/glasses.png')
        this.load.image('necklace_dress', '../../assets/choose_accessory/necklace_dress.png')
        this.load.image('dress/flower/glasses/girl', '../../assets/girl/dress/flower/glasses/girl.png')
        this.load.image('dress/flower/necklace/girl', '../../assets/girl/dress/flower/necklace/girl.png')
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'dress/flower/girl')
        ...
        let necklace = this.add.sprite(sceneWidth*0.75, sceneHeight/1.3, 'necklace_dress').setInteractive()
        necklace.setScale(0)
        ...
        function putGlasses () {
            destroyElements()
            girl = objectScene.add.image(sceneWidth/2, sceneHeight/2, 'dress/flower/glasses/girl')
            girl.setScale(scaleObject)
            addProgress()
            addChoose()
            startTimer()
        ...
        function putNecklace () {
            destroyElements()
            girl = objectScene.add.image(sceneWidth/2, sceneHeight/2, 'dress/flower/necklace/girl')
            girl.setScale(scaleObject)
            addProgress()
            addChoose()
            startTimer()
        ...
        const addChoose = () => {
            ...
            this.glasses = glasses
            necklace = this.add.sprite(sceneWidth*0.75, sceneHeight/1.3, 'necklace_dress').setInteractive()
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.accessory=='glasses') this.scene.start('sceneDressFlowerGlassesChooseBack');
            else this.scene.start('sceneDressFlowerNecklaceChooseBack');
        }
    }
}
