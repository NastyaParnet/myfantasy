export default class sceneDressFlowerNecklaceChooseBack extends Phaser.Scene {
    constructor(){
        super('sceneDressFlowerNecklaceChooseBack')
    }
    preload(){
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'dress/flower/necklace/girl')
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.accessory=='beach') this.scene.start('sceneDressFlowerNecklaceBeach');
            else this.scene.start('sceneDressFlowerNecklaceSea');
        }
    }
}
