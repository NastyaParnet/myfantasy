export default class sceneDressFlowerGlassesChooseBack extends Phaser.Scene {
    constructor(){
        super('sceneDressFlowerGlassesChooseBack')
    }
    preload(){
    ...
    create(){
        ...
        let girl = this.add.image(sceneWidth/2, sceneHeight/2, 'dress/flower/glasses/girl')
    ...
    update(){
        if(this.timer>0) {
            ...
            if(this.accessory=='beach') this.scene.start('sceneDressFlowerGlassesBeach');
            else this.scene.start('sceneDressFlowerGlassesSea');
        }
    }
}
