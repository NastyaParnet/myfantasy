export default class sceneDressFlowerGlassesBeach extends Phaser.Scene {
    constructor(){
        super('sceneDressFlowerGlassesBeach')
    }
    preload(){
    ...
    create(){
        ...
        this.girl = this.add.image(-200, sceneHeight/1.9, 'dress/flower/glasses/girl')
